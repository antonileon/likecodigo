@extends('layouts.app')
@section('title', __('Registrar paciente'))
@section('css')
@endsection
...
@section('content')
  ...
  <div class="content">
    <nav class="breadcrumb push bg-body-extra-light rounded-pill px-4 py-2">
      <a class="breadcrumb-item" href="{{ route('pacientes.index') }}">Pacientes</a>
      <span class="breadcrumb-item active">Registrar</span>
    </nav>
    <!-- Dynamic Table Full -->
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title"><i class="nav-main-link-icon fa fa-user-tie"></i> Registrar paciente</h3>
      ...
      <form action="{{ route('pacientes.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off" data-parsley-validate>
