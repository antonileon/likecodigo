...
<div class="content">
  ...
  <div class="row">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-shadow text-center" href="https://demo.pixelcave.com/codebase/be_pages_generic_inbox.html">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-shadow text-center" href="https://demo.pixelcave.com/codebase/be_pages_generic_profile.html">
        <div class="block-content">
          <p class="my-3">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-shadow text-center" href="https://demo.pixelcave.com/codebase/be_pages_forum_categories.html">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-shadow text-center" href="https://demo.pixelcave.com/codebase/be_pages_generic_search.html">
        <div class="block-content">
          <p class="my-3">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-shadow text-center" href="https://demo.pixelcave.com/codebase/be_comp_charts.html">
        <div class="block-content">
          <p class="my-3">
